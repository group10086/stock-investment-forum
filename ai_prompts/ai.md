...
#### 任务：生成交互场景文档（use_cases.md）

**原始提示词：**
> 作为产品经理，为【股票基金投资论坛】编写完整的交互场景文档。有26个用户故事（用户系统6个、内容系统6个、社交系统5个、信息整合4个、管理运营5个）。需要：1) 每个用户故事对应一个用例(UC-01~UC-25) 2) 每个用例包含名称、参与者、前置条件、后置条件、基本流程、扩展流程 3) 关键业务流程的系统交互图 4) 边界情况与异常处理表

**AI输出摘要：**
AI生成了完整的交互场景文档 `docs/use_cases.md`，包括：
- 25个标准用例（UC-01~UC-25）
- 每个用例含完整的参与者、前置/后置条件、基本流程、扩展流程
- 3个系统交互图（用户认证流程、发帖与敏感词过滤流程、举报处理流程）
- 边界情况与异常处理表（覆盖10种异常场景）
